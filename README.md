...
- `images/` — photography and media; `images/branding/` holds full-resolution logo sources (`vtgms-logo.png` = hero/footer wordmark from sticker art; `vtgms-badge.png` = compact header mark)
